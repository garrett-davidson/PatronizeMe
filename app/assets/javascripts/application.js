...
// lib/assets/javascripts, or any plugin's vendor/assets/javascripts
...
//= require_tree .
		...
		function h(e) {
			if(window.addEventListener) {
				window.addEventListener("message",function(t) {if(e.id===t.data.sender){e.height=t.data.height}},false)
			}
		}
		function o(r,a){ a=a||n; if(!a) {
			...
			return y}var v=s("github-card");
			for(r=0;
				r<v.length;
				r++){o(v[r])}if(window.githubCard){window.githubCard.render=o}}